...
void CNATConnectivityAnalyzerLogic::DoFullAnalysis()
{
	//Get internal IP
	emit updatedStatus("Getting Internal IP");
	...
	emit updatedInternalIP(internalIPString);

	//Get the STUN info
	emit updatedStatus("Running STUN test");
